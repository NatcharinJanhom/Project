<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row navbar-danger">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="no_user.php">
            <img style="" src="theme/assets/images/tomato/tomato_logo.png" alt="logo" />
            Tomato
          </a>
          <a class="navbar-brand brand-logo-mini" href="no_user.php">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item  d-none d-xl-inline-block">
              ...
              <img class="img-sm rounded-circle" src="theme/assets/images/faces/blank_face.jpg" alt="Profile image"> </a>
            </li>
          </ul>
