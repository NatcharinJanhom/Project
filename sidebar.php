              ...
              <div class="nav-link">
                <div class="user-wrapper">
                  <div class="profile-image">
                    <img src="theme/assets/images/faces/face1.jpg" alt="profile image"> </div>
        ...
        <div id="right-sidebar" class="settings-panel">
          ...
          <ul class="chat-list">
            <li class="list active">
              <div class="profile">
                <img src="theme/assets/images/faces/face1.jpg" alt="image">
            ...
            <li class="list">
              <div class="profile">
                <img src="theme/assets/images/faces/face2.jpg" alt="image">
            ...
            <li class="list">
              <div class="profile">
                <img src="theme/assets/images/faces/face3.jpg" alt="image">
                <span class="online"></span>
              </div>
              <div class="info">
                <p>Daniel Russell</p>
            ...
            <li class="list">
              <div class="profile">
                <img src="theme/assets/images/faces/face4.jpg" alt="image">
                <span class="offline"></span>
              </div>
              <div class="info">
            ...
            <li class="list">
              <div class="profile">
                <img src="theme/assets/images/faces/face5.jpg" alt="image">
                <span class="online"></span>
              </div>
              <div class="info">
            ...
            <li class="list">
              <div class="profile">
                <img src="theme/assets/images/faces/face6.jpg" alt="image">
                <span class="online"></span>
              </div>
              <div class="info">
                <p>Sarah Graves</p>
