                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" id="imagebase64" name="imagebase64">
                                ...
                                <div class="form-group">                                    
                                    <input name="cb" type="radio" id="cb1" value="1" checked><label for="cd1" style="vertical-align:text-top;text-align:center; padding:0 10px 0 10px;">Crop by circle </label>
                                    <input name="cb" type="radio" id="cb2" value="2"><label for="cd2" style="vertical-align:text-top; text-align:center; padding:0 10px 0 10px;">Crop by square  </label>                    
                                ...
                                <div class="btn-group">
                                <button type="button" class="btn btn-inverse-dark active  btn-sm pic-left"><i class="fa fa-image"></i><i class="fa fa-align-justify"></i></button>
                                <button type="button" class="btn btn-inverse-dark  btn-sm pic-right"><i class="fa fa-align-justify"></i><i class="fa fa-image"></i></button>
                                </div>
                                </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="card-body">
                                                        <form action="" id="form" method="post">
                                                            ...
                                                            <div class="cenbut">
                                                            <input type="file" id="upload" value="" ><br><br>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="card">
                                                    <div class="card-body">
                                                        <h4 align="center" class="preview_title" id="preview_title"></h4><br>
